...
export const MOCK_PROCESSES: Process[] = [
  {
    ...
    status: 'waiting', moduleMode: 'both', copySchedule: 'now', imageSchedule: 'now',
    progress: 100,
  ...
  },
  {
    ...
    status: 'processing', moduleMode: 'both', copySchedule: 'now', imageSchedule: 'now',
    progress: 55,
  ...
  },
  {
    ...
    status: 'completed', moduleMode: 'both', copySchedule: 'now', imageSchedule: 'now',
    progress: 100,
  ...
  },
  {
    ...
    status: 'error', moduleMode: 'both', copySchedule: 'now', imageSchedule: 'now',
    progress: 30,
